...
testServerCfg(){
    runSrvCfg 1
    pkill -9 blscosi_withpull
    testFile srv1/private.toml
}

testBuild(){
    testOK ./blscosi_withpull help
}
...
runCl(){
    ...
    dbgRun ./blscosi_withpull -d $DBG_APP $@ -g $D
}
...
runSrv(){
    ( ./blscosi_withpull -d $DBG_SRV server -c srv$1/private.toml & )
