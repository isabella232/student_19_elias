...
import (
	...
	"github.com/dedis/student_19_elias/blscosi_hybrid_rumor/blscosi_hybrid_rumor/check"
...
func writeSigAsJSON(res *blscosi_hybrid_rumor.SignatureResponse, outW io.Writer) error {
...
func sign(msg []byte, tomlFileName string) (*blscosi_hybrid_rumor.SignatureResponse, error) {
...
func verify(fileName, sigFileName, groupToml string) error {
	...
	sig := &blscosi_hybrid_rumor.SignatureResponse{}
