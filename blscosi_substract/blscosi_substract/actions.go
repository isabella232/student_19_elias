...
import (
	...
	"github.com/dedis/student_19_elias/blscosi_substract/blscosi_substract/check"
...
func writeSigAsJSON(res *blscosi_substract.SignatureResponse, outW io.Writer) error {
...
func sign(msg []byte, tomlFileName string) (*blscosi_substract.SignatureResponse, error) {
...
func verify(fileName, sigFileName, groupToml string) error {
	...
	sig := &blscosi_substract.SignatureResponse{}
