...
import (
	...
	"github.com/dedis/student_19_elias/blscosi_maskaggr/blscosi_maskaggr/check"
...
func writeSigAsJSON(res *blscosi_maskaggr.SignatureResponse, outW io.Writer) error {
...
func sign(msg []byte, tomlFileName string) (*blscosi_maskaggr.SignatureResponse, error) {
...
func verify(fileName, sigFileName, groupToml string) error {
	...
	sig := &blscosi_maskaggr.SignatureResponse{}
