// Package blscosi_maskaggr implements a service and client that provides an API
// to request a signature to a cothority
package blscosi_maskaggr

import (
	"errors"
	"time"

	"github.com/dedis/student_19_elias/blscosi_maskaggr/protocol"
