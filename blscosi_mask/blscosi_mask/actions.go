...
import (
	...
	"github.com/dedis/student_19_elias/blscosi_mask/blscosi_mask/check"
...
func writeSigAsJSON(res *blscosi_mask.SignatureResponse, outW io.Writer) error {
...
func sign(msg []byte, tomlFileName string) (*blscosi_mask.SignatureResponse, error) {
...
func verify(fileName, sigFileName, groupToml string) error {
	...
	sig := &blscosi_mask.SignatureResponse{}
