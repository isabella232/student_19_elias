...
import (
	...
	"github.com/dedis/student_19_elias/blscosi_rumor/blscosi_rumor/check"
...
func writeSigAsJSON(res *blscosi_rumor.SignatureResponse, outW io.Writer) error {
...
func sign(msg []byte, tomlFileName string) (*blscosi_rumor.SignatureResponse, error) {
...
func verify(fileName, sigFileName, groupToml string) error {
	...
	sig := &blscosi_rumor.SignatureResponse{}
