// Package blscosi_rumor implements a service and client that provides an API
// to request a signature to a cothority
package blscosi_rumor

import (
	"errors"
	"time"

	"github.com/dedis/student_19_elias/blscosi_rumor/protocol"
...
const ServiceName = "rumorCoSiService"
